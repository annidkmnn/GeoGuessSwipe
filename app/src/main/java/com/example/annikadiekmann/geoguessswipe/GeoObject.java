...
public class GeoObject {
    ...
    private boolean mGeoImageInEurope;

    public GeoObject(String mGeoName, int mGeoImageName, boolean mGeoImageInEurope) {
        this.mGeoImageName = mGeoImageName;
        this.mGeoName = mGeoName;
        this.mGeoImageInEurope = mGeoImageInEurope;
    }
        ...
        public boolean getmGeoImageInEurope() {
        return mGeoImageInEurope;
        }

        public void setmGeoImageInEurope(boolean mGeoImageInEurope) {
        this.mGeoImageInEurope = mGeoImageInEurope;
        }
    ...
    public static final String[] PRE_DEFINED_GEO_OBJECT_NAMES = {
        ...
        public static final boolean[] PRE_DEFINED_GEO_OBJECT_IMAGE_IN_EUROPE = {
                true,
                false,
                false,
                true,
